  ...
  "pm_tools": {{
    "picks": [
      {{
        "name": "项目名",
        "url": "github链接",
        "description": "对产品经理的价值（50字内）",
        "use_case": "适用PM场景（20字内）",
        "stars": 0,
        "rating": 4
      }}
    ],
    "summary": "PM工具整体推荐语（50字内）"
  }},
  "finance_tools": {{
    "picks": [
      {{
        "name": "项目名",
        "url": "github链接",
        "description": "金融业价值（50字内）",
        "use_case": "适用金融场景（20字内）",
        "stars": 0,
        "rating": 4
      }}
    ],
    "summary": "金融开源工具整体推荐语（50字内）"
  }}
}}

要求：trending精选5个，pm_tools精选3-5个，finance_tools精选3-5个，rating为1-5星。"""
